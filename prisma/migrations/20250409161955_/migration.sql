...
ADD COLUMN     "accountStatus" TEXT NOT NULL DEFAULT 'inactive',
...
CREATE TABLE "Admin" (
    "id" SERIAL NOT NULL,
    "username" TEXT NOT NULL DEFAULT 'default_admin_username',
    "password" TEXT NOT NULL DEFAULT 'default_admin_username',
    "email" TEXT NOT NULL,
